                    ...
                    <form action="{{ route('post.create') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-8">
                                <input type="text" name="tags" class="form-control" placeholder="Tags. Attach at less 1 and not more than 5 ">
                            </div>
                            <div class="mb-3 col-md-2">
                                <a href="" class="form-control" style="text-align:center; padding-top:10px">
                                    <span class="fw-normal">SEO Setting</span>
                                </a>
                            </div>
                            <div class="mb-3 col-md-2">
                        ...
                        <div class="mb-3 ">
                            <textarea class="form-control" placeholder="Content..." maxlength="500" name="content" id="editor1"
                                rows="100" cols="80"></textarea>
                        </div>
                    </form>
                </div>
            </div>
